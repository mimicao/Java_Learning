...
#    s_lat = raw_input("纬度(N/S):");
    ...
    new_posn_pkg = []
    print posn_pkg[0]-lat_offset
    new_posn_pkg.appned(posn_pkg[0]-lat_offset)
    new_posn_pkg.appned(posn_pkg[1]-lat_offset)
    new_posn_pkg.appned(posn_pkg[2]-lon_offset)
    new_posn_pkg.appned(posn_pkg[3]-lon_offset)
    
    for item in new_posn_pkg:
        print item     
